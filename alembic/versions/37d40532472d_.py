...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_dim_countries_country'), 'dim_countries', ['country'], unique=False)
    ...
    op.create_table('dim_macro_parameters',
    ...
    op.create_table('fact_economic_calendar',
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_table('fact_macro_indicators',
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('date', sa.DateTime(), nullable=True),
    ...
    sa.Column('currency_or_measurement', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('governanceEpochDate', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    sa.Column('compensationAsOfEpochDate', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    ...
    sa.Column('underlyingSymbol', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    ...
    sa.Column('firstTradeDateEpochUtc', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    sa.Column('timeZoneFullName', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    sa.Column('timeZoneShortName', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    ...
    sa.Column('financialCurrency', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    sa.Column('trailingPegRatio', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    ...
    sa.ForeignKeyConstraint(['country'], ['dim_countries.country'], ),
    sa.PrimaryKeyConstraint('id'),
    comment='List of public listed companies'
    )
    op.create_index(op.f('ix_dim_companies_symbol'), 'dim_companies', ['symbol'], unique=False)
